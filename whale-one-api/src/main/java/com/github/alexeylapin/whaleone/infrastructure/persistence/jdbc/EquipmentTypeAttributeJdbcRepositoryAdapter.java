...
public class EquipmentTypeAttributeJdbcRepositoryAdapter implements EquipmentTypeAttributeRepository {
    ...
    EquipmentTypeAttributeMapper MAPPER = Mappers.getMapper(EquipmentTypeAttributeMapper.class);
    ...
    public EquipmentTypeAttribute save(EquipmentTypeAttribute equipmentTypeAttribute) {
        var entity = MAPPER.toEntity(equipmentTypeAttribute);
    ...
    public Optional<EquipmentTypeAttribute> findById(long id) {
        return delegate.findById(id).map(MAPPER::fromEntity);
    }
    ...
    public Page<EquipmentTypeAttribute> findAll(long equipmentTypeId) {
        ...
        return new DefaultPage<>(page.map(MAPPER::fromEntity));
    }
    ...
    interface EquipmentTypeAttributeMapper {
        ...
        EquipmentTypeAttribute fromEntity(EquipmentTypeAttributeEntity entity);

        EquipmentTypeAttributeEntity toEntity(EquipmentTypeAttribute attribute);
